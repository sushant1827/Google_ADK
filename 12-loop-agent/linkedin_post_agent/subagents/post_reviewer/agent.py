...
This agent reviews LinkedIn posts for quality and provides feedback or exits the loop if requirements are met.
"""

from google.adk.agents.llm_agent import LlmAgent
from .tools import count_characters, exit_loop

# Define the LinkedIn Post Reviewer Agent
post_reviewer_agent = LlmAgent(
    name="post_reviewer_agent",
    model="gemini-2.0-flash",
    description="Reviews LinkedIn posts for quality and provides feedback or exits the loop if requirements are met.",
    instruction="""
    You are a LinkedIn Post Quality Reviewer Agent.
